...
運用要件がいたずらに自動化されることにより、実運用の現場でその条件が発動
した場合に二次障害が発生する場合もあります。
...
(Ops' job is enable the business)ということに象徴されるように、DevOpsが目指すものは、
...
分業が必要という状況は、DevOpsというものが語られるようになっても存在しているわけです。
