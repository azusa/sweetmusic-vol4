...
そしてその延長線上にあるクラウドであり、その特徴を生かしたのがInfrastrcture as Codeです。
...
SoRはビジネスを支援するためにアジリティーを意識すべきだし、SoEは刹那的なKPIに踊らされずに長期的な視野を持つべきである、
ということになります。
...
- なので、開発環境へのデイリーデプロイからはじめて、チーム内部でのデプロイの
サイクルを短くすることからはじめていくのがいい
- その後に、本番環境へのリリース短縮に取り組み、最終的には本番環境上で
A/Bテストのように試行が出来るようにするのがよい
...
実務を担当する側がわかれてるとコストの増大とリードタイムの増加が起きるというものです。

また、組織が拡大していく中で○○に応じて分業を進めていくことは、プロジェクトの中に
複数の異なる方向性と意思を持った組織が存在することを定常化し、プロジェクトが一つの
ゴールに向かって進むことを難しくします。

個人がカバーできる技術領域を広げていくことが求められる一方で、
ソフトウェア開発に関する技術の高度化、専門家の流れは止められないため、
何らかの形で分業は必要という相反する状況があります。
