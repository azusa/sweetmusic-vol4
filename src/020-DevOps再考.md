...
例えば作業時のダブルチェックやバックアップ処理などの運用の定常処理に対する監視
などです。
...
ソフトウェアのデバッグを行う上でグラフィカルかつインタラクティブなデバッガーを使う
ことが普及しておらず、コード補完などのインテリジェンスな機能を有しないテキストエディター
...
- SoRはもうちょっとビジネスを支援することを考えなさい
- SoEはもうちょっと長期的な視野を持ちなさい
